...
class Portfolio(models.Model):
    ...
    additional_text = models.TextField(blank=True, null=True, help_text="Qo'shimcha matn yoki ma'lumot")
    link = models.URLField(blank=True, null=True, help_text="link")
    category = models.ForeignKey(Category, on_delete=models.CASCADE, related_name="portfolios", help_text="Portfolio kategoriyasi")  # Category bilan bog'lash
